  ...
  return (
    ...
    >
      ...
      {toast && (
        <div
          role="status"
          className="pointer-events-none fixed bottom-[calc(24px+env(safe-area-inset-bottom))] left-1/2 z-50 w-[min(90vw,430px)] -translate-x-1/2 rounded-2xl bg-stone-900 px-4 py-3 text-sm text-white shadow-xl"
        >
          {toast}
        </div>
      )}
