...
| Existing bundled Korean font files are broad             | `src/styles/index.css` and Fontsource imports | Local Noto typography is an existing identity and offline contract                           | Future performance/subsetting pass                       |
