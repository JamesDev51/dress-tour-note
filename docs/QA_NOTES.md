...
The final browser gate allows enough time for client-side Korean font embedding, dress rendering, PDF download, and cross-device-style restoration to complete on a cold CI runner.
